            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pull-right">
                        <a href="{{route('cessions')}}" id="btn_show_data" class="btn btn-sm btn-primary"
                           title="Show Data">
                ...
                <div class="card card-accent-primary">
                    <div class="card-header">
                        <div class="pull-left">
                            <i>
                                <strong>
                                    <a data-toggle="collapse" data-parent="#accordion" href="#searchperson"
                            ...
                            <form class="form-horizontal" method="get" action="{{route('findApplications')}}">
                                <div class="box-tools">
                                    <div class="input-group input-group-sm" style="width: 400px;">
                                        <select name="field" id="field" class="form-control input-group-lg reg_name"
                                                required>
                            ...
                            <form class="form-horizontal" action="{{route('updateCession')}}" method="post">
                                ...
                                <div class="box-tools">
                                    <div class="input-group input-group-sm" style="width: 400px;">
                                        ...
                                        <select name="status" id="status" class="form-control input-group-lg reg_name"
                                                required>
                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <button type="submit" title="search" class="btn btn-primary"><i
