        ...
        <div class="card card-accent-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-sm table-bordered table-hover ">
                    ...
                    <tbody>
                        @forelse($batches as $gender)
                        <tr>
                            <td>{{$gender->id}}</td>
                            <td>{{$gender->batch}}</td>
                            <td>
                                {{$gender->batchtype->batchtype}}
                                <div class="pull-right box-tools">
                                    <a class="btn-sm btn btn-warning" href="{{route('showBatch',$gender->id )}}" title="View Details"><i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn-sm btn btn-primary" href="{{route('editBatch',$gender->id )}}" title="Edit Details"><i class="fa fa-pencil-square-o"></i>
                                    </a>
