            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="pull-right">
                            ...
                            <a href="{{route('propertytypes')}}" id="btn_show_data" class="btn btn-sm btn-primary" title="Show Data">
                                <i class="fa fa-table"></i> Show Data
                            </a>


                            <a href="{{route('createPropertyTypes')}}" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong>Edit Poperty Type</strong>
                        <small>Form</small>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{route('updatePropertyType',$types->id )}}">
                            <input class="hidden" type="hidden" name="updated_by" value="{{Auth::user()->id}}">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="form-group">
                                <label for="gender">Property Type</label>
                                <input type="text"  name="type" value="{{$types->type}}" class="form-control">
                            </div>
