    ...
    <table class="tableBordered"  style="width: 100%; font-size: 0.8em;" >
        <tr>
            ...
            <td colspan="4" width="70%">
                ...
                <h4 style=" font-size:12pt; font-weight:normal;" class="center">REFUNDS REPORT </h4>
...
<div>
    <table class="table"  style="width: 100%; font-size: 0.8em;" border="0">
        ...
        @forelse($loans as $key => $loan)
            ...
            <tr>
                ...
                <td > <span style="font-size:9pt;">$ {{$loan->loan_balance  * -1}}</span></td>
            </tr>
            @endif
        @empty
        @endforelse
    ...
    <table width="100%"  style="width: 100%; font-size: 0.8em;" border="0">
        <tr>
            ...
            <td width="30%" align="right">$ {{$loans->sum('loan_balance') * -1}}</td>
        </tr>
    </table>
    <hr>
    <div class="footer">
