    ...
    <table class="tableBordered"  style="width: 100%; font-size: 0.8em;" >
        <tr>
            ...
            <td colspan="4" width="70%">
                ...
                <h4 style=" font-size:12pt; font-weight:normal" >{{$product->product_name}} LOANS REPORT </h4>
...
<div>
    <table class="table"  style="width: 100%; font-size: 0.8em;" border="0">
        ...
        @forelse($loans as $key => $loan)
            ...
            <tr>
                ...
                <td  >{{$loan->client->person->first_name}}<span style="font-size:9pt;"></span></td>
    ...
    <table width="100%"  style="width: 100%; font-size: 0.8em;" border="0">
        ...
        <tr>
            <td width="70%">Number of Loans</td>
            <td width="30%" align="right"> {{$loans->count()}}</td>
        </tr>
    </table>
    <hr>
    <div class="footer">
