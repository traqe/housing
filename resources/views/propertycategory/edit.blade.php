        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <strong>Edit Poperty Category</strong>
                    <small>Form</small>
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('updatePropertyCategory',$types->id )}}">
                        <input class="hidden" type="hidden" name="updated_by" value="{{Auth::user()->id}}">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        <div class="form-group">
                            <label for="gender">Property Category</label>
                            <input type="text" name="category" value="{{$types->category}}" class="form-control">
                        </div>
