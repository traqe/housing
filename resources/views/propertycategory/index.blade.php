        ...
        <div class="card">
            <div class="card-body">
                <div class="pull-right">
                    ...
                    <a href="{{route('propertycategories')}}" id="btn_show_data" class="btn btn-sm btn-primary" title="Show Data">
                        <i class="fa fa-table"></i> Show Data
                    </a>


                    <a href="{{route('createPropertyCategories')}}" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="pull-right box-tools">
                                    <a class="btn-sm btn btn-warning" href="{{route('showPropertyCategory',$type->id)}}" title="View Details"><i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn-sm btn btn-primary" href="{{route('editPropertyCategories',$type->id )}}" title="Edit Details"><i class="fa fa-pencil-square-o"></i>
                                    </a>
