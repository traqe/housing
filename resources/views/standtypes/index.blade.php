                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="pull-right box-tools">
                                    <a class="btn-sm btn btn-warning" href="{{route('showStandType',$gender->id )}}" title="View Details"><i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn-sm btn btn-primary" href="{{route('editStandType',$gender->id )}}" title="Edit Details"><i class="fa fa-pencil-square-o"></i>
                                    </a>
