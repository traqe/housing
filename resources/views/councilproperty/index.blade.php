        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="pull-right">
                        ...
                        <a href="{{route('createCouncilProperties')}}" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
            ...
            <div class="card card-accent-primary">
                <div class="card-header">
                    ...
                    <strong>Council Properties</strong>
                    <small>Table</small>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover"  id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$property->validity_status}}
                                    <div class="pull-right box-tools">
                                        <a class="text-warning"
                                           href="{{route('showCouncilProperty',$property->id )}}"
                                           title="View Details"><i class="fa fa-eye"></i>
                                        </a>
                                        <a  class="text-primary"
                                            href="{{route('editCouncilProperties',$property->id )}}"
        ...
        <div class="modal fade" id="deleteC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form  class="form-horizontal" action="/councilproperties/{{0}}" method="post">
