            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong>Edit Batch Type</strong>
                        <small>Form</small>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{route('updateBatchType',$batchtype->id )}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="batchtype" value="{{$batchtype->batchtype}}" class="form-control">
                            </div>
