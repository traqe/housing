    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="pull-left">
                    <h3><i class="fa fa-file-pdf-o"> Applications</i></h3>
                </div>
                        ...
                        <i>
                            <strong>
                                <a data-toggle="collapse" data-parent="#accordion" href="#searchperson" aria-expanded="false" class="collapsed">
                                    <h5><strong><i class="fa fa-search"> Search for Applications </i></strong></h5>
                                </a>
                            </strong>
                        </i>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card card-accent-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{route('updateAllocation')}}" method="post">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 400px;">
                                        ...
                                        <td>
                                            ...
                                            <div class="pull-right box-tools">
                                                ...
                                                <label class="switch switch-icon switch-primary">
                                                    <input type="checkbox" class="switch-input" name="id[]" value="{{$staff->unApprovedAllocations->first()->id}}">
