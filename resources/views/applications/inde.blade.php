            ...
            <div class="card">
                <div class="card-body">
                    <div class="pull-right">
                        ...
                        <a href="/staffs" id="btn_show_data" class="btn btn-sm btn-primary" title="Show Data">
                            <i class="fa fa-table"></i> Show Data
                        </a>


                        <a href="/staffs/create" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <a data-toggle="modal"  onclick="getDepartment('{{$staff->id}}')"  class="btn-sm btn btn-danger"
                                           href="#deleteD"
