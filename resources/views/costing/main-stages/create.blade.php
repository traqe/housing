        ...
        <div class="card card-accent-primary">
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('store-costing-main-stage') }}">
                        {{csrf_field()}}
                        ...
                        <button type="submit" class="btn btn-primary btn-flat pull-right"><span class="fa  fa-check-circle"></span> Save Stage</button>
