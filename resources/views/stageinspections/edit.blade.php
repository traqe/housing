                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('updateStageInspection',$stage_insp->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value=" {{ $stage_insp->remarks }}" name="remarks" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="grave">Contractors</label>
                            <input type="text" value=" {{ $stage_insp->contractors }}" name="contractors" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="grave">Witness</label>
                            <input type="text" value=" {{ $stage_insp->witness }}" name="witness" class="form-control" required>
                        </div>
