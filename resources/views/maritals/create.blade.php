            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pull-right">
                            ...
                            <a href="/maritals" id="btn_show_data" class="btn btn-sm btn-primary" title="Show Data">
                                <i class="fa fa-table"></i> Show Data
                            </a>


                            <a href="/maritals/create" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
                ...
                <div class="card box-primary">
                    <div class="card-header">
                        ...
                        <strong>Create Marital Status</strong>
                        <small>Form</small>
                    </div>
                    <div class="card-body">
                        <form method="post" action="/maritals">
                            <input class="hidden" type="hidden" name="created_by" value="{{Auth::user()->id}}">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="gender">Marital Status</label>
                                <input type="text"  name="maritalstatus" class="form-control" required>
                            </div>
