                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pull-right">
                            ...
                            <a href="/parents" id="btn_show_data" class="btn btn-sm btn-primary" title="Show Data">
                                <i class="fa fa-table"></i> Show Data
                            </a>


                            <a href="/parents/create" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
