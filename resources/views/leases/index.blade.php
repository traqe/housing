                        ...
                        <tr>
                            ...
                            <td>
                                <div class="pull-right box-tools">
                                    <a class="text-warning" href="{{url('lease/'.$lease->id)}}" title="Show Details"><i class="fa fa-eye"></i>
                                    </a>
                                    <a class="text-primary" href="{{url('lease/'.$lease->id.'/edit')}}" title="Edit Details"><i class="fa fa-pencil-square-o"></i>
                                    </a>
                                    <?php
